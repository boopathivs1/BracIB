...
//		enterByXpathExplict(prop.getProperty("enter.otp.password.xpath"),"123456");
	...
	public BillPaymentsPage billerForm(String fieldname,String value) throws InterruptedException{
	    ...
	    break; 
	    case "Met policy Number":
	    	String metPolicynum=regvalue(value);	

	    enterByXpathExplict(prop.getProperty("enter.metpolicynum.xpath"),metPolicynum); 
	    break; 
...
scrolltoelementJs(prop.getProperty("sms.billpayments.xpath"));
	    ...
	    break;  
	    	    ...
	    	    case "ClickSmsThird": 
	    	    	Thread.sleep(2000);
	    	    	scrolltoelementJs(prop.getProperty("Click.sms.utility.smsthree.xpath"));
	    	    			clickByXpathExplict(prop.getProperty("Click.sms.utility.smsthree.xpath"));
	    	    		    break;  
