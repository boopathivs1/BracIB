...
public class Tc_87  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC87";
		testDescription="Forgot PIN/Generate New PIN-Debit card";
		browserName="Chrome";
		dataSheetName="Barac";
		category="Regression";
		authors="Boopathi";
	...
	public void mobileBillRegularPayments(String casename,String Username,String Password,String Otp,String services,
			...
			String confirmpin,String year,String month,String reason,String data10,String data11,String data12,String data13,String data14,String data15,String data16) throws Exception{
