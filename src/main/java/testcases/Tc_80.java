...
public class Tc_80  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC80";
		testDescription="Grameenphone (One Time Pay)";
		browserName="Chrome";
		dataSheetName="Barac";
		category="Regression";
		authors="Boopathi";
...
.filterTransactionHistory(fromacc, beneficiarytype, channeltype,toaccount)
