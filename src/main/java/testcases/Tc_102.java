...
public class Tc_102  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC102";
		testDescription="Fund Transfer-Other Bank-One time Payment -Credit Card Type-Minimum Amount and Maximum Amount";
		browserName="Chrome";
		dataSheetName="Barac";
		category="Regression";
		authors="Boopathi";
...
//	.transferOtherBankOnTimePayForm(fromACC, amount, toAccount, acctype)
	...
	.transferOtherOneTimePayForm(fromACC,Minimumamount, toAccount, acctype)
	.verifyAmountMinmsg()
