...
public class Tc_81  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC81";
		testDescription="Bangalink (with Beneficiaries)";
		browserName="Chrome";
		dataSheetName="Barac";
		category="Regression";
		authors="Boopathi";
...
//.MobileBillerPayForm("billPayRemarks","Premium")
//.MobileBillerPayForm("TransAmount",amount)
.MobileBillerPayForm("MobilepayAmount",amount)
.MobileBillerPayForm("billPayRemarks","Premium")
//.MobileBillerPayForm("TransAmount",amount)
//.MobileBillerPayForm("MobileTransAmount",amount)
