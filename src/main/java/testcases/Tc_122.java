...
public class Tc_122  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC122";
		testDescription="Pay Insurance(One Time Payment)-Metlife-Minimum Amount and Maximum Amount";
		browserName="Chrome";
		dataSheetName="Barac";
		category="Regression";
		authors="Boopathi";
	...
	public void mobileBillRegularPayments(String casename,String Username,String Password,String Otp,String billermenu,String billerName,
			...
			String beneficiarytype,String channeltype,String transHistoryToAccount,String maximumamount,String data9,String data10,String data11,String data12,String data13,String data14,String data15,String data16) throws Exception{
